...
1. Execute `gradle setupDevWorkspace`. This sets up Forge and downloads the necessary libraries to build StartingInventory. This might take some time, be patient.
